    ...
    projects: [
      ...
      },
      {
        ...
        content: "<p class='black-font'>"+
                    ...
                    "<br><br>When I moved to San Francisco I spent a lot of time going to different Hackathons, and one of them was the Shirts.io Hackathon. My team won by turning any <a href='<a href='https://www.dribbble.comhttp://developer.dribbble.com/'>Dribbble</a> account into a shirt store. We won $5,000 worth of shirts and decided to keep working in the app. In the process Dribbble launched their <a href='http://developer.dribbble.com/'>API’s new version</a> that included OAuth 2.0 as protocol for authentication. Since we were using the MEAN stack and passport.js as an authentication library, I wrote the Dribbble strategy and open sourced it. This contribution gets downloaded a couple of times a day at least which makes me really happy."+
      ...
      },
      {
        ...
        content: "<p class='black-font'>"+
                    "I have a huge passion for <a href='https://www.flickr.com/photos/sebabelmar'>photography</a>. I've spent hours in the outdoors catching sunrises, sunsets, wild life. But I never thought that I would use that experience professionally, until I started my own business."+
                    "<br><br>At <a href='https://www.masonbottle.com'>Mason Bottle</a> we have limited resources and the need for visual assets is huge. In addition to shooting pictures and videos, I learned production, post production and how to use most of the Above Creative Suite."+
